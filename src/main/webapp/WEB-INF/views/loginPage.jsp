...
<ul>
  	...
  	<div class="main">
		<div id="centerwrap"> 
		<form:form action="/home" method="post" modelAttribute="loginform">
		<h5>Login to your account</h5></br>
		<div>
		<label for="username" style="color: #FF1493" ><ion-icon name="person"></label>
		
		<form:input type="text" path="username" placeholder="User Name"/></ion-icon></br></br>
		
		<div><label for="pwd" style="color: #FF1493"><ion-icon name="lock-closed"></label>
		<form:input type="text" path="password" placeholder="Password" /></br></br>
		<center>
			<button class="pushable" type="submit" value="login"> 
				<span class="front"><a style="color:white;text-decoration: none">Log In</a></span></button>
